...
export default function Navbar() {
  return (
    <nav className="bg-[#529471] border-gray-200 dark:bg-[#529471] shadow-lg fixed top-0 left-0 right-0 z-40">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
            <p className='text-2xl logo text-white'>Grocerily</p>
        </a>
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            <div className='text-white text-3xl relative'>
                <button><AiOutlineShoppingCart/></button>
                <div className="absolute bg-red-500 w-3.5 h-3.5 top-0 right-0 text-xs flex justify-center items-center rounded-full">0</div>
            </div>
        ...
        <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-[#529471] md:dark:bg-[#529471] dark:border-gray-700 ">
            <li>
